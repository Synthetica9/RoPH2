...
PRE["Bandit's"]=WEPPrefix("Bandit's",PD=1.25,MD=1.25,AC=0.85,WT=1,Buy=1.2,Sell=1.2)
...
WEP["Spear"]=Weapon(Name="Spear",PD=1.15,MD=1.15,AC=1.15,WT=1.15,Buy=1.15,Sell=1.15)
WEP["Lance"]=Weapon(Name="Lance",PD=1.15,MD=1.15,AC=1.15,WT=1.15,Buy=1.15,Sell=1.15)
...
WEP["Microphone"]=Weapon(Name="Microphone",PD=0,MD=0,AC=1.75,WT=0.25,Buy=2,Sell=2)
...
WEP["Melodica"]=Weapon(Name="Melodica",PD=0,MD=3,AC=0.6,WT=1.4,Buy=2.5,Sell=2.5)
