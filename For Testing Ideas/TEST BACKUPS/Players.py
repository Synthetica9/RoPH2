...
def Brad(Unit):
	...
	if choice=="ST" or choice == "St" or choice == "st":
		...
		if choice == "1":
			choice=input("Select an Action!\n [Q]uick!\n [N]ormal!\n [H]ard!\n [L]ongshot!\n [C]lipshot!\n [A]rrow Item!\n [U]nknown Skill!\n ")
			if choice == "Q" or choice == "q":
				AttacksOO.Bow(WSD["Brad"].Weapon1,"Brad",Lunar,1.25,25,0).QATK
			elif choice == "N" or choice == "n":
				AttacksOO.Bow(WSD["Brad"].Weapon1,"Brad",Lunar,1.25,25,0).NATK
			elif choice == "H" or choice == "h":
				AttacksOO.Bow(WSD["Brad"].Weapon1,"Brad",Lunar,1.25,25,0).HATK
			elif choice == "L" or choice == "l":
				AttacksOO.Bow(WSD["Brad"].Weapon1,"Brad",Lunar,1.25,25,0).Longshot
			elif choice == "C" or choice == "c":
				AttacksOO.Bow(WSD["Brad"].Weapon1,"Brad",Lunar,1.25,25,0).Clipshot
			elif choice == "A" or choice == "a":
				AttacksOO.Bow(WSD["Brad"].Weapon1,"Brad",Lunar,1.25,25,0).ArrowItem
			elif choice == "U" or choice == "u":
