...
while running == 1:
	...
	if choice == "P" or choice == "p":
		...
		if choice == "L" or choice == "l":
			Enemies.Higgins("Higgins")
		elif choice == "C" or choice == "c":
			Enemies.Marshal("Marshal")
		elif choice == "S" or choice == "s":
			Enemies.Todd("Todd")
		...
		if choice == "E" or choice == "e":
			with open('C:\\Users\\seven\\OneDrive\\Desktop\\RoPH OOP Update\\For Testing Ideas\\EnergyBar.py','a+') as f:
				...
				print("FreakENE="+str(min(WSD["Freak"].ENE,EnergyBar.FreakENE+round(WSD["Freak"].ENE*0.1))),file=f)
				print("ToddENE="+str(min(WSD["Todd"].ENE,EnergyBar.ToddENE+round(WSD["Todd"].ENE*0.1))),file=f)
				print("MarshalENE="+str(min(WSD["Marshal"].ENE,EnergyBar.MarshalENE+round(WSD["Marshal"].ENE*0.1))),file=f)
